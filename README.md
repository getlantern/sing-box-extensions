...
The goal of Lantern Box is simply to be as useful as possible. Developers and infrastructure operators are encouraged to run Lantern Box servers and to distribute them to users, and we will continually contribute changes upstream whenever possible.
